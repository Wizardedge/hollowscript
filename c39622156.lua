...
function c39622156.initial_effect(c)
	...
	e3:SetOperation(c39622156.regop)
	c:RegisterEffect(e3)
end
c39622156.xyz_number=26
function c39622156.regop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetAttackTarget()~=nil then return end
	local c=e:GetHandler()
	c:RegisterFlagEffect(39622156+1,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_DAMAGE,0,1)
end
...
function c39622156.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(39622156+1)~=0
end
