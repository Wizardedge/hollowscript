...
function c15862758.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(100000)
	e1:SetReset(RESET_EVENT+RESETS_STANDARD-RESET_TEMP_REMOVE-RESET_LEAVE+RESET_OVERLAY)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e2:SetLabel(turn)
	e2:SetReset(RESET_EVENT+RESETS_STANDARD-RESET_TEMP_REMOVE-RESET_LEAVE+RESET_OVERLAY)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetLabel(turn)
	e4:SetReset(RESET_EVENT+RESETS_STANDARD-RESET_TEMP_REMOVE-RESET_LEAVE+RESET_OVERLAY)
	c:RegisterEffect(e4)
end
