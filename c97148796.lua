...
function c97148796.excostfilter(c,tp)
	return c:IsAbleToRemove() and c:IsHasEffect(101106066,tp)
end
function c97148796.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(100)
	local g1=Duel.GetReleaseGroup(tp,true):Filter(c97148796.costfilter,e:GetHandler(),tp)
	local g2=Duel.GetMatchingGroup(c97148796.excostfilter,tp,LOCATION_GRAVE,0,nil,tp)
	g1:Merge(g2)
