...
function c5352328.filter(c)
	return c:IsPreviousLocation(LOCATION_GRAVE)
end
function c5352328.spcon(e,tp,eg,ep,ev,re,r,rp)
	return (rp==1-tp and eg:IsExists(c5352328.filter,1,nil)) or (eg:IsExists(Card.IsSummonPlayer,1,nil,1-tp) and eg:IsExists(c5352328.filter,1,nil))
end
