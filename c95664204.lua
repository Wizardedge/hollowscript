...
function c95664204.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sg:GetCount()>0 and Duel.SpecialSummon(sg,0,tp,tp,false,false,POS_FACEUP)>0
		...
		and Duel.IsExistingMatchingCard(c95664204.ccfilter,tp,LOCATION_MZONE,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(95664204,2)) then
