...
function c16474916.filter(c)
	return c:IsPreviousLocation(LOCATION_GRAVE)
end
function c16474916.spcon(e,tp,eg,ep,ev,re,r,rp)
	return (rp==1-tp and eg:IsExists(c16474916.filter,1,nil)) or (eg:IsExists(Card.IsSummonPlayer,1,nil,1-tp) and eg:IsExists(c16474916.filter,1,nil))
end
